...
namespace Salesforce.Force
{
    public interface IForceClient: IDisposable
    {
        ...
        Task<T> QueryByIdWithJSONPropertyAsync<T>(string objectName, string recordId);
        ...
        Task<CompositeResponseRoot> CreateCompositeAsync(CompositeRequestRoot request,bool isAllowNullValues);
